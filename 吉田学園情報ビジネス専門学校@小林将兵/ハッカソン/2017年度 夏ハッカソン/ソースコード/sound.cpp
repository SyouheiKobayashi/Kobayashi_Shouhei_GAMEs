...
{
	{"data/BGM/bgm0001.wav", -1},		// BGM0
	{"data/BGM/bgm0000.wav", -1},		// BGM1
	{"data/BGM/bgm0002.wav", -1},		// BGM2
	{"data/SE/shot000.wav", 0},			// 弾発射音
	{ "data/SE/laser002.wav", 0 },			// 弾発射音
	...
	{"data/SE/valcan.wav", 0},		// バルカンコール
	{"data/SE/spread.wav", 0},		//スプレッドコール
	{ "data/SE/canon.wav", 0 },	//キャノンコール
	{ "data/SE/canonfire.wav", 0 },		//キャノンショット
	{ "data/SE/spreadshot.wav", 0 },	//スプレッドショット
	{ "data/SE/ovarheat.wav", 0 },		//オーバーヒート
	{ "data/SE/warning.wav", 0 },      //警告音
	{ "data/SE/lockon000.wav", 0 },		//オーバーヒート
	{ "data/SE/slash.wav", 0 },		//オーバーヒート
	{ "data/SE/slash2.wav", 0 }		//オーバーヒート
};

...
void UpdateCLEAR(void)
{
	...
	if (GetKeyboardTrigger(DIK_RETURN) == false)
	{
		g_pVtxBuffCLEAR->Lock(0, 0, (void**)&pVtx, 0);
		//タイトルカラー
		pVtx[4].col = D3DCOLOR_RGBA(g_aClear + 50, g_aClear - 10, g_aClear - 0, 255);
		pVtx[5].col = D3DCOLOR_RGBA(g_aClear + 60, g_aClear - 20, g_aClear - 0, 255);
		pVtx[6].col = D3DCOLOR_RGBA(g_aClear + 70, g_aClear - 30, g_aClear - 0, 255);
		pVtx[7].col = D3DCOLOR_RGBA(g_aClear + 80, g_aClear - 40, g_aClear - 0, 255);
		//頂点バッファアンロックする
		g_pVtxBuffCLEAR->Unlock();
		//頂点バッファをロックし、頂点データへのポインタ
		g_pVtxBuffCLEAR->Lock(0, 0, (void**)&pVtx, 0);
			//プレスエンターカラー
			pVtx[8].col = D3DCOLOR_RGBA(g_aClear * 2, 0, 0, 255);
			pVtx[9].col = D3DCOLOR_RGBA(g_aClear * 2, 0, 0, 255);
			pVtx[10].col = D3DCOLOR_RGBA(g_aClear * 2, 0, 0, 255);
			pVtx[11].col = D3DCOLOR_RGBA(g_aClear * 2, 0, 0, 255);
			//頂点バッファアンロックする
			g_pVtxBuffCLEAR->Unlock();
	}
}

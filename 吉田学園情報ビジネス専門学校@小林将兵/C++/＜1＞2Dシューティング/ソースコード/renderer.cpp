...
void CRenderer::Update(void)
{
	...
	if (pGame != NULL)
	{
		PauseFlag = pGame->GetPauseFlag();
		ContinuityFlag = pGame->GetContinuityFlag();
		bGiveUp = pContinuity->GetGiveUpFlag();
	...
	if (PauseFlag == false&& ContinuityFlag == false || bGiveUp == true)//どちらも表示してないとき
	{
		CScene::UpdateAll();//通常更新
	}
	else if (PauseFlag == true || ContinuityFlag == true )
	{
		CScene::UpdateAll(CScene::OBJ_DRAW::DRAW_PAUSE);
	}

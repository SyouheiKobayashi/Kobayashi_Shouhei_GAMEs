...
// マクロ定義
//=============================================================================
#define	TEXTURE_NAME	"data/TEXTURE/number003.png"	// 読み込むテクスチャファイル名
#define TIMER_SET (6)//制限時間
#define MAX_DISPLAY (3)//表示桁数
#define TIMER_WIDTH (25.0f)//横サイズ
#define TIMER_HEIGHT (32.0f)//縦サイズ
...
void InitTimer(void)
{
	...
	g_Timer.pos = D3DXVECTOR3(190, 110, 0.0f);
...
void UpdateTimer(void)
{
	...
	if (g_Timer.nTime == 0)//残り時間0、リザルト画面へ
	{
		FADE pFade;

...
void InitScore(void)
{
	...
	g_posScore = D3DXVECTOR3(900.0f, 50.0f, 0.0f);
...
void MakeVertexScore(LPDIRECT3DDEVICE9 pDevice)
{
	...
	{
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(g_posScore.x - 25.0f, g_posScore.y -20.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_posScore.x +25.0f, g_posScore.y - 20.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_posScore.x - 25.0f, g_posScore.y + 20.0f , 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_posScore.x + 25.0f, g_posScore.y + 20.0f, 0.0f);

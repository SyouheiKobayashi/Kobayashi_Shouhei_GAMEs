...
//? マクロ
//? ==================================================
#define Tutorial_TEXTURENAME "DATA\\TEXTURE\\TUTORIAL00.jpg"		//読み込むテクスチャ
...
void InitTutorial(void)
{
	...
	//◇頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(Tutorial_POS_X + Tutorial_WIDTH, Tutorial_POS_Y, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(Tutorial_POS_X + Tutorial_WIDTH, Tutorial_POS_Y + Tutorial_HEIGHT, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(Tutorial_POS_X, Tutorial_POS_Y, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(Tutorial_POS_X, Tutorial_POS_Y + Tutorial_HEIGHT, 0.0f);
